            ...
            switch (holder.getItemViewType()) {
                ...
                case 1: {
                    ...
                    if (position == inappSoundRow) {
                        ...
                        checkCell.setTextAndValueAndCheck(LocaleController.getString("NotificationsService", R.string.NotificationsService), LocaleController.getString("NotificationsServiceInfo", R.string.NotificationsServiceInfo), preferences.getBoolean("pushService", Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2 ? isNotificationListenerEnabled() : getMessagesController().keepAliveService), true, true);
                    } else if (position == notificationsServiceConnectionRow) {
